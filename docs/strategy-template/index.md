...
??? note "Address Common Challenges, Problems and Obstacles with ODAM"
    ...
    <figure markdown>
        ![Common Challenges Comic](/assets/strategy-template/common-challenges-comic.png){ width="800" }
    </figure>
    ...
    <figure markdown>
        ![Address Common Challenges, Problems, and Obstacles](/assets/strategy-template/common-challenges.png){ width="800" }
    </figure>
...
??? note "ODAM’s Impact on CDO, CIO, and CISO Goals"
    ...
    <figure markdown>
        ![C-Suite Goals](/assets/strategy-template/c-suite-goals.png){ width="800" }
    </figure>
...
??? note "Focus Areas and Guiding Principles"
    ...
    <figure markdown>
        ![Focus Area and Guiding Principles](/assets/strategy-template/focus-area.png){ width="800" }
    </figure>
...
??? note "The ODAM Use Case Lifecycle: A Guide to Developing and Implementing Data Analytics"
    ...
    <figure markdown>
        ![Use Case Lifecycle](/assets/strategy-template/lifecycle.png){ width="800" }
    </figure>
    ...
    <figure markdown>
        ![Lifecycle Details](/assets/strategy-template/lifecycle-details.png){ width="800" }
    </figure>
...
??? note "Outcomes When Using ODAM"
    ...
    <figure markdown>
        ![Benefits of Visibility](/assets/strategy-template/benefits-of-visibility.png){ width="800" }
    </figure>
